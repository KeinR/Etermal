bin/main.o: src/main.cpp src/shell/ArgFilter.h src/shell/Args.h src/shell/EShell.h src/shell/ETerminal.h src/shell/Shell.h src/shell/data/ArgData.h src/terminal/Resources.h src/terminal/Scroll.h src/terminal/Terminal.h src/terminal/TextBuffer.h src/terminal/gui/Rectangle.h src/terminal/gui/Scrollbar.h src/terminal/render/Buffer.h src/terminal/render/Color.h src/terminal/render/Font.h src/terminal/render/FontLibrary.h src/terminal/render/Model.h src/terminal/render/Texture.h src/terminal/render/ftype.h src/terminal/shader/Primitive.h src/terminal/shader/Shader.h src/terminal/shader/Texture.h src/terminal/util/Timer.h src/terminal/util/enums.h src/terminal/util/singleton.h src/terminal/util/util.h
...
bin/terminal.Terminal.o: src/terminal/Terminal.cpp src/shell/EShell.h src/shell/ETerminal.h src/shell/TermInput.h src/terminal/Resources.h src/terminal/Scroll.h src/terminal/State.h src/terminal/Terminal.h src/terminal/TextBuffer.h src/terminal/gui/Rectangle.h src/terminal/gui/Scrollbar.h src/terminal/render/Buffer.h src/terminal/render/Color.h src/terminal/render/Font.h src/terminal/render/FontLibrary.h src/terminal/render/Model.h src/terminal/render/Texture.h src/terminal/render/ftype.h src/terminal/render/glfw.h src/terminal/shader/Primitive.h src/terminal/shader/Shader.h src/terminal/shader/Texture.h src/terminal/util/Timer.h src/terminal/util/enums.h src/terminal/util/singleton.h src/terminal/util/util.h
bin/terminal.TextBuffer.o: src/terminal/TextBuffer.cpp src/terminal/Resources.h src/terminal/TextBuffer.h src/terminal/gui/Rectangle.h src/terminal/render/Buffer.h src/terminal/render/Color.h src/terminal/render/Font.h src/terminal/render/FontLibrary.h src/terminal/render/Model.h src/terminal/render/Texture.h src/terminal/render/ftype.h src/terminal/shader/Primitive.h src/terminal/shader/Shader.h src/terminal/shader/Texture.h src/terminal/util/singleton.h
